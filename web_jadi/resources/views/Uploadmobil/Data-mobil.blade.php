            ...
            <div class="card-body">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td >
                        <a href="{{ asset('mobil/'. $item->upload_foto ) }}" target="_blank" rel="noopener noreferrer">Lihat Foto</a>
                        </td>
                        <td>
                        <a href="{{ url('edit-mobil',$item->id) }}"><i class="fas fa-edit"></i></a> 
                        | 
                        <a href="{{ url('delete-mobil',$item->id) }}"><i class="fas fa-trash-alt" style="color: red"></i></a>
                        </td>
