            ...
            <div class="card-body">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>{{ $item->alamat }}</td>
                        <td>
                        <a href="{{ asset('user/'. $item->upload_foto ) }}" target="_blank" rel="noopener noreferrer">Lihat Foto</a>
                        </td>
                        <td>
                        <a href="{{ asset('user/'. $item->upload_ktp ) }}" target="_blank" rel="noopener noreferrer">Lihat Foto KTP</a>
                        </td>
                        <td>
