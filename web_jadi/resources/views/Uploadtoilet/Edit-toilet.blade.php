            ...
            <div class="content">
                <div class="card card-info card-outline">
                    <div class="card-header">
                        <h3>Ubah Data Bersih Toilet</h3>
                    </div>

                    <div class="card-body">
                        <form action="{{ route('update-toilet', $dt->id) }}" method="post"
                            enctype="multipart/form-data">
                            {{ csrf_field() }}

                            <div class="form-group">
                                <label class="control-label" for="hargalayanan">Harga Layanan</label>
                                <input type="text" id="hargalayanan" name="hargalayanan" placeholder="Harga Layanan"
                                    class="form-control @error('hargalayanan') 
                    ...
                    is-invalid @enderror" autofoucus>
                            ...
                            <div class="form-group">
                                <img src="{{ asset('toilet/'. $dt->upload_foto ) }}" height="5%" width="10%" alt=""
                                    srcset="">
                            </div>
                            <div class="form-group">
