  ...
  <div class="content-wrapper">
    ...
    <div class="content">
        <div class="card card-info card-outline">
            ...
            <div class="card-body">
                <form action="{{ route('update-artikel', $dt->id) }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                  ...
                  <div class="form-group">
                  <label class="control-label" for="isiartikel">Isi Artikel</label>
                    <input type="text" id="isiartikel" name="isiartikel" placeholder="Isi Artikel" class="form-control @error('isiartikel') 
                    is-invalid @enderror" value="{{ old('name', $dt->isiartikel) }}">
                    @error('isiartikel')
                    <div class="invalid-feedback">{{ $message}}</div>
                    @enderror
                  </div>
                  ...
                  <div class="form-group">
                    <img src="{{ asset('artikel/'. $dt->upload_foto ) }}" height="5%" width="10%" alt="" srcset="">
                  </div>
