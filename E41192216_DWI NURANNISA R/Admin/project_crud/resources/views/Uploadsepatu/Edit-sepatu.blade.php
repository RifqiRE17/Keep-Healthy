  ...
  <div class="content-wrapper">
    ...
    <div class="content">
        <div class="card card-info card-outline">
            ...
            <h3>Ubah Data Bersih Sepatu</h3>
            </div>

            <div class="card-body">
                <form action="{{ url('update-sepatu', $dt->id) }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <img src="{{ asset('sepatu/'. $dt->upload_foto ) }}" height="5%" width="10%" alt="" srcset="">
                  </div>
                  <div class="form-group">
