            ...
            <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <label class="control-label" for="jabatan">Jenis Kelamin</label>
                    <input type="text" id="jeniskelmain" name="jeniskelamin" class="form-control" placeholder="Jenis Kelamin" value="{{ $dt->jeniskelamin }}">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <img src="{{ asset('user/'. $dt->upload_foto ) }}" height="5%" width="10%" alt="" srcset="">
                  </div>
                  <div class="form-group">
