  ...
  <div class="content-wrapper">
    ...
    <div class="content">
        <div class="card card-info card-outline">
            ...
            <h3>Ubah Data Bersih Mobil</h3>
            </div>

            <div class="card-body">
                <form action="{{ route('update-mobil', $dt->id) }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                  ...
                  <div class="form-group">
                    <img src="{{ asset('mobil/'. $dt->upload_foto ) }}" height="5%" width="10%" alt="" srcset="">
                  </div>
                  <div class="form-group">
