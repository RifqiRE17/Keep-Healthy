            ...
            <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <label class="control-label" for="jabatan">Jabatan</label>
                    <input type="text" id="jabatan" name="jabatan" class="form-control" placeholder="Jabatan" value="{{ $dt->jabatan }}">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <img src="{{ asset('img/'. $dt->upload_foto ) }}" height="5%" width="10%" alt="" srcset="">
                  </div>
                  <div class="form-group">
                    <input type="file" id="upload_ktp" name="upload_ktp" class="form-control">
                  </div>
                  <div class="form-group">
                    <img src="{{ asset('img/'. $dt->upload_ktp ) }}" height="5%" width="10%" alt="" srcset="">
                  </div>
                  <div class="form-group">
