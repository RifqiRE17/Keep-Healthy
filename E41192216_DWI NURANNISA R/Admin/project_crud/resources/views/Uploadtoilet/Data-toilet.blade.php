        ...
        <div class="card card-info card-outline">
            <div class="card-header">
                <div class="card-tools">
                    <a href="{{ route('create-toilet') }}" class="btn btn-success">Tambah Data <i class="fas fa-plus-square"></i></a>
                </div>
                </div>
            ...
            <div class="card-body">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        | 
                        <a href="{{ url('delete-toilet',$item->id) }}"><i class="fas fa-trash-alt" style="color: red"></i></a>
                        </td>
